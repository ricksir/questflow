...
const styles = StyleSheet.create({
  ...
  sampleBanner: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'flex-start', justifyContent: 'space-between', gap: 10, paddingVertical: 9, paddingHorizontal: 11, borderRadius: 12, backgroundColor: 'rgba(60,200,220,0.07)', borderWidth: 1, borderColor: 'rgba(60,200,220,0.22)' },
  ...
  intervalBand: { position: 'absolute', top: 2, bottom: 2, borderRadius: 999, backgroundColor: 'rgba(37,199,217,0.52)' },
