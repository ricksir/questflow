...
const styles = StyleSheet.create({
  ...
  screenHeader: { position: 'relative', overflow: 'hidden', flexDirection: 'row', flexWrap: 'wrap', alignItems: 'flex-start', gap: 12, paddingVertical: 16, paddingHorizontal: 4, borderBottomWidth: 1, borderBottomColor: palette.border, backgroundColor: 'transparent' },
  screenHeaderAccent: { position: 'absolute', left: 4, top: 7, width: 34, height: 3, borderRadius: 999, backgroundColor: palette.primary },
  screenHeaderCopy: { flex: 1, minWidth: 210, gap: 3, paddingLeft: 4 },
  screenHeaderTitle: { color: palette.text, fontSize: 34, lineHeight: 38, fontWeight: '900', letterSpacing: -1.2 },
  screenHeaderAction: { alignSelf: 'center', maxWidth: '100%' },
