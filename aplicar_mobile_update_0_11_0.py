...
PAYLOAD = ROOT / 'mobile_update_payload_0.11.0' / 'mobile'
TARGET = ROOT / 'mobile'
...
def restore_source(backup: Path) -> None:
    """Restore only Mobile source/config, never native/cache/dependency directories."""
...
def main() -> int:
    ...
    backup = BACKUPS / f'mobile_source_before_0.11.0_{stamp}'
    ...
    print('OK: QuestFlow Mobile source atualizado para 0.11.0.')
    print('Backup:', backup)
    print('node_modules, .expo e diretorios nativos foram preservados.')
    print('Para uso realmente offline sem Metro/Studio, gere e instale um build Preview/Production do Mobile 0.11.0.')
    return 0
