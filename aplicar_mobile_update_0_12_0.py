...
PAYLOAD = ROOT / 'mobile_update_payload_0.12.0' / 'mobile'
TARGET = ROOT / 'mobile'
...
def main() -> int:
    ...
    backup = BACKUPS / f'mobile_source_before_0.12.0_{stamp}'
    ...
    print('OK: QuestFlow Mobile source atualizado para 0.12.0.')
    print('Backup:', backup)
    print('node_modules, .expo e diretorios nativos foram preservados.')
    print('IMPORTANTE: para remover definitivamente o botao flutuante do Dev Client, gere/instale uma nova build nativa 0.12.0.')
    return 0
