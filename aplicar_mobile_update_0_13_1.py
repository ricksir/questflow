...
PAYLOAD = ROOT / 'mobile_update_payload_0.13.1' / 'mobile'
TARGET = ROOT / 'mobile'
...
def main() -> int:
    ...
    backup = BACKUPS / f'mobile_source_before_0.13.1_{stamp}'
    ...
    print('OK: QuestFlow Mobile source atualizado para 0.13.1.')
    print('Backup:', backup)
    print('node_modules, .expo e diretorios nativos foram preservados.')
    print('IMPORTANTE: para remover definitivamente o botao flutuante do Dev Client, gere/instale uma nova build nativa 0.13.1.')
    return 0
