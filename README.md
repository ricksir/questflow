...
- API versionada do Studio em `/api/v1/studio`; Configurações e o Revisar Banco já usam o contrato v1 para lista, detalhe, criação manual, salvamento/aprovação e ciclo de vida (excluir/anular), enquanto o RPC `/api/call` permanece para fluxos ainda não migrados.
