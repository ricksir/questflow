...
- API versionada do Studio em `/api/v1/studio`; Configurações e a listagem do Revisar Banco já usam o contrato v1 diretamente, enquanto o RPC `/api/call` permanece para fluxos ainda não migrados.
